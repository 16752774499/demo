            ...
            .then(function(response) {
                ...
                let middle_body = `
                    <div class="filename-section">
                        <input id="inputFileName" type="text" placeholder="请输入文件名" class="styled-input">
                    </div>
                    <div class="data-list">
                `;
                ...
                firstList.forEach(function(element) {
                    middle_body += `
                        <div class="data-item">
                            <div class="textbox">${element}</div>
                            <input id="inputKey" type="text" placeholder="请输入字段名" class="styled-input">
                        </div>
                    `;
                });
                ...
                let end_body = `
                        ...
                        <div class="button-group">
                            <button id='saveJson' class="action-button json">保存JSON</button>
                            <button id='saveExcel' class="action-button excel">保存Excel</button>
                        </div>
                    </div>
                </div>`;
